...
target "agentbloat" {
  ...
  labels = merge(
    oci_labels(
      "tools/ai/agentbloat", "agentbloat",
...
target "claude-code" {
  ...
  labels = merge(
    oci_labels(
      "tools/ai/claude-code", "claude-code", "Claude Code CLI on devbox",
...
target "open-code-review" {
  ...
  matrix   = { variant = ["ubuntu", "alpine", "ubuntu-browser", "alpine-browser"] }
  inherits = ["_agent"]
  context  = "tools/ai/open-code-review"
  ...
  labels = merge(
    oci_labels(
      "tools/ai/open-code-review", "open-code-review", "Alibaba Open Code Review CLI on devbox",
...
target "omnigent" {
  ...
  labels = merge(
    oci_labels(
      "tools/ai/omnigent", "omnigent", "Omnigent agent meta-harness on agentbloat",
...
target "t3code" {
  ...
  labels = merge(
    oci_labels(
      "tools/ai/t3code", "t3code", "T3 Code web GUI for coding agents on agentbloat",
