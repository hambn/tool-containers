...
configure_systemd() {
    ...
    install -m 0644 /tmp/workspace-systemd-container.conf \
        /etc/systemd/system.conf.d/workspace-container.conf
    install -m 0644 /tmp/workspace-journald-container.conf \
        /etc/systemd/journald.conf.d/workspace-container.conf
    install -m 0644 /tmp/workspace-tmpfiles-tmp.conf /etc/tmpfiles.d/tmp.conf
