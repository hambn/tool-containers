...
for route in repository-changes maintain-agent-workspace repository-map container-images documentation web-ui; do
...
# shellcheck disable=SC2016 # literal skill token
