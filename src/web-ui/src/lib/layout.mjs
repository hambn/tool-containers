...
function head({ page, meta: pageMeta, config, assets, structuredData }) {
  const title =
    page.kind === "home" ? pageMeta.title : `${pageMeta.title} · ${SITE_NAME}`;
  ...
  return [
    ...
    meta(
      "property",
      "og:type",
      page.kind === "tool" || page.kind === "example" ? "article" : "website",
    ),
    ...
    meta(
      "property",
      "og:image:alt",
      `${SITE_NAME} — container images for AI agents, CI and sandboxes`,
    ),
...
<p class="footer-note">tool-containers</p>
<nav class="footer-links" aria-label="Footer">
${source ? `<a href="${config.blobUrl(source)}" rel="noopener">View Markdown</a>` : ""}
