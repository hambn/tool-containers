...
and tool and platform READMEs under `src/tools/`. The browser receives HTML, one shared CSS
...
1. `src/lib/catalog.mjs` discovers `src/tools/<category>/<tool>/README.md` and
   `src/tools/<category>/<tool>/examples/<platform>/README.md`.
