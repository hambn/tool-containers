...
- [kubectl](https://kubernetes.io/docs/tasks/src/tools/install-kubectl-linux/), [Helm](https://helm.sh/), [Kustomize](https://github.com/kubernetes-sigs/kustomize), [yq](https://github.com/mikefarah/yq)
